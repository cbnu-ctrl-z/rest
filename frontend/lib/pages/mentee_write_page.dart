...
class MenteeWritePage extends StatefulWidget {
  @override
  _MenteeWritePageState createState() => _MenteeWritePageState();
}

class _MenteeWritePageState extends State<MenteeWritePage> {
  ...
  Future<void> _submitPost(String id, String name) async {
    ...
    try {
      final url = '${dotenv.env['API_URL']}/mentee/write';
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: '멘토링을 받고 싶은 분야나 구체적인 도움이 필요한 내용을 자세히 작성해주세요.\n\n예시:\n• 원하는 멘토링 분야\n• 현재 상황과 목표\n• 구체적으로 도움받고 싶은 내용',
                              hintStyle: TextStyle(
                                color: Colors.grey[400],
                                fontSize: 14,
                                height: 1.5,
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  '구체적이고 명확한 글일수록 더 좋은 멘토를 만날 수 있어요!',
                                  style: TextStyle(
                                    color: Colors.grey[600],
                                    fontSize: 12,
                                  ),

...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future<void> _signUp() async {
    ...
    const url = 'http://172.30.64.60:5000/signup'; // 또는 필요한 주소로 변경
    try {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildPasswordField(controller: _passwordController, focusNode: _passwordFocus, label: '비밀번호', isConfirm: false),
                      _buildPasswordField(controller: _confirmPasswordController, focusNode: _confirmPasswordFocus, label: '비밀번호 확인', isConfirm: true),
                      SizedBox(height: 20),
                      ElevatedButton(
                        onPressed: _signUp,
